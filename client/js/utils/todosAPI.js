...
let updateTodoNameInput = document.querySelector("#update-todoName-input");
let updateTodoIdInput = document.querySelector("#update-todoId-input");
...
async function updateTodoAPI(evt) {
  ...
  let formData = {
    name: updateTodoNameInput.value,
  };
